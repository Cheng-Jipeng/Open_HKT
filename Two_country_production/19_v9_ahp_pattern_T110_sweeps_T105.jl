# This file is included after 19_v9_ahp_pattern_T110_replication.jl.  It uses
# that file's calibrated parameter factory, hard-validity gates, CSV helpers,
# and plotting defaults.
...
const NB19_SWEEP_BRANCH_ITER_SCHEDULE = [60, 200, 500, 1000]
...
function nb19_solve_sweep_case(pi_case::Float64, gamma_case::Float64;
    ...
    if !validity.valid
        ...
        for field in (
            ...
            :accounting_exact, :finite_accounting, :exact_common,
        ...
        return (;
            ...
            accounting, common, validity, attempt_rows,
        )
    end
...
nb19_sweep_attempt_columns = [
    ...
    "T_max", "branch_iters", "warm_start_T", "status", "elapsed_sec",
...
function nb19_sweep_bound_data(case)
    ...
    summary = (;
        ...
        nu_b_eff_monotone_decreasing=all(<(0), diff(nu_b_eff_full)),
